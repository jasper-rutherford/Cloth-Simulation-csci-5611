...
//        I (Jasper Rutherford) DID NOT WRITE THIS
//            The only things I changed:
//                - Removed example use code from bottom
//                - Switched up/down from e/q to space/shift
//                - Switched speed button from shift to control
...
class Camera
{
  ...
  void HandleKeyPressed()
  {
    ...
    if ( key == 'e' || key == 'E' ) shiftPressed = true; 
    if (shiftPressed){
